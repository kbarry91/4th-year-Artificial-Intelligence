...
public class ImageClassifier {
	private String[] names = { "a Demon", "an Egg", "a Flying Pig", "a Hawk", "an Ice Cream", "a Man with a Hat",
			"the Moon", "a Pigeon", "a Rabbit", "a Radar", "a Razor", "a Robot", "a Saw", "a Scary Skull", "a Spiral",
			"a Swiss Roll", "a Tree", "a Woman" };
	private double[][] data;
